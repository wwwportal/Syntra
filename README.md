...
- [QTouch](https://github.com/wwwportal/QTouch) — A client-server card game in Java with a Swing GUI, MVC architecture, and SQLite persistence.
- [StudentAssessmentSystem](https://github.com/wwwportal/StudentAssessmentSystem) — A C++ student grade tracking system with a Nana GUI.
- [Structural](https://github.com/wwwportal/Structural) — A civil engineering domain-specific language and compiler written in Prolog.
- [Operations-Management-System](https://github.com/wwwportal/NFL-Operations-Management-System) — A Java application for managing NFL team operations via CSV-backed data files.
- [Pulse](https://github.com/wwwportal/Pulse) — A safety-verifying software-to-hardware compiler bridging continuous-variable logic with silicon-photonic processors.
- [PaintingPortal](https://github.com/wwwportal/PaintingPortal) — A PHP/MySQL e-commerce web app for browsing and purchasing paintings.
...
- [brightspace-cli](https://github.com/wwwportal/brightspace-cli) — A CLI calendar and task viewer for the Brightspace learning management system.
- [Scribe](https://github.com/wwwportal/Scribe) — A tool for downloading and transcribing audio from a YouTube video.
